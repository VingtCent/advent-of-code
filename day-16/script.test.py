...
Valve JJ has flow rate=21; tunnel leads to valve II"""
    ...
    #     self.assertEqual(_impl.answer1(), 1651)

    def test_answer_simplecase(self):
        "Test answer for part 1."
        example = """Valve AA has flow rate=1; tunnels lead to valves BB
Valve BB has flow rate=10; tunnels lead to valves AA"""
        _impl = ProboscideaVolcanium(example.splitlines())
        self.assertEqual(_impl.answer1(), 280 + 26)
